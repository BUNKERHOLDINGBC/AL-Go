...
| <a id="nuGetFeedAllowPrerelease"></a>nuGetFeedAllowPrerelease | Determines whether to allow prerelease versions when finding Business Central app packages from NuGet feeds. | False |
