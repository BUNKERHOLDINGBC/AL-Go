...
$defaultBcContainerHelperVersion = "https://github.com/BUNKERHOLDINGBC/navcontainerhelper/archive/refs/heads/main.zip" # Must be double quotes. Will be replaced by BcContainerHelperVersion if necessary in the deploy step - ex. "https://github.com/organization/navcontainerhelper/archive/refs/heads/branch.zip"
